...
APK=~/bin/apk.static
APK_SHA256=96226e5edefd0a46fb471a12fc8e7e0034c466e1da89676945e64552e3cd0be5
APKTOOL_BASEURL=${MIRROR}/v${DVER}/main/x86_64/
APKTOOL_FILE=apk-tools-static-2.7.5-r0.apk
APKTOOL_FILE_SHA256=5b063627faf59c41f883cbdccfd7c4be85acb36681a749c02513644a7166455a
